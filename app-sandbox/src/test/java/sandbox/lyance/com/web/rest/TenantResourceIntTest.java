...
import sandbox.lyance.com.repository.TenantRepository;
...
public class TenantResourceIntTest {
    ...
    public void createTenant() throws Exception {
        ...
        assertThat(testTenant.getDomainName()).isEqualTo(DEFAULT_DOMAIN_NAME);
    }
    ...
    public void updateTenant() throws Exception {
        ...
        assertThat(testTenant.getDomainName()).isEqualTo(UPDATED_DOMAIN_NAME);
    }
